...
export function CollectionsIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      <rect x="6.5" y="6.5" width="14" height="14" rx="2.5" stroke="currentColor" strokeWidth="2" />
      <path d="M3.5 9.5v9a2.5 2.5 0 0 0 2.5 2.5h9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <circle cx="11.5" cy="11.5" r="1.5" fill="currentColor" />
      <path d="M9 17l2.5-3 2 2 2.5-3.5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function RewardsIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M8.5 14.5 7 21l5-2.5 5 2.5-1.5-6.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9.5 9l1.7 1.7L14.5 7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
